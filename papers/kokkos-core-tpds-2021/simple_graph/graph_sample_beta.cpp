...
int main(int argc, char* argv[]) {
...

  {
	...
	ready.then_parallel_reduce(N, dotp_functor{x, z}, beta);
      });
	...
	Kokkos::parallel_for(N, AxpbyNoGraph<EXECSPACE>{x, y, alpha, beta_no_graph});
	Kokkos::parallel_for(N, AxpbyNoGraph<EXECSPACE>{z, y, gamma, beta_no_graph});
	Kokkos::parallel_reduce(N, dotp_functor{x, z}, beta_no_graph);
	ex.fence();
